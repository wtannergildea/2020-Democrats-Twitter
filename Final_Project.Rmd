...
# Visualization top 25 words per candidate. This code was used to test the functionality,
# but the working code is kept in the app.R file. 
...
polite_table <- politeness(cleaned_t$text, parser = "none", drop_blank = TRUE)
